...
public class Parties implements CommandInterface
{
	...
	public Parties()
	{
		...
		commands.add(ChatColor.DARK_AQUA + "/party" + ChatColor.AQUA + " leave" + ChatColor.GRAY + " - Leave The Current Party.");
		commands.add(ChatColor.DARK_AQUA + "/party" + ChatColor.AQUA + " chat" + ChatColor.GRAY + " - Chat With Party Members.");
		...
		commands.add(ChatColor.DARK_AQUA + "/party" + ChatColor.AQUA + " merge <name>" + ChatColor.GRAY + " - Invites Another Party Leader To Merge Parties.");
